  ...
  return {
    ...
    keywords: {
      variable:
		...
		'PeriodStart PeriodEnd FilterCharges NoSub UseFields MultipleYears LoggedInUser MySelectedClasses MySelectedEnglishClass MySelectedHebrewClass ForceTurbo ',
      literal:
